...
public class ConsumerManager {
     ...
     * @param consumeType  消费者获取消息的方式类型 主动拉取 | 广播站退推送
     * @param messageModel 消息模型 集群|
     * @param consumeFromWhere 消费者从何处开始消费消息
     * @param subList 消息者订阅的主题列表
     * @param isNotifyConsumerIdsChangedEnable 是否发送通知消息者的id变更
     * @return
     */
